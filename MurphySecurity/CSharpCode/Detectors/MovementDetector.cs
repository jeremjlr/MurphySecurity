...
{
    public class MovementDetector : Detector
    {
        public long MovementCode { get; private set; }

        public MovementDetector(long movementCode, string name)
        {
        ...
        public override void UpdateStatus(long code)
        {
            ...
            if (code == MovementCode)
                AlertManager.IntrusionAlert.LaunchAlert();
        }

        public override long[] GetCodes() { return new long[] { MovementCode }; }
    }
}
